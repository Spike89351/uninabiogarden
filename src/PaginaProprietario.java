...
public class PaginaProprietario extends JFrame {
	...
	public PaginaProprietario(String username, Controller c) {
		...
		gl_panelCentral.setHorizontalGroup(
			gl_panelCentral.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panelCentral.createSequentialGroup()
					...
					.addGap(27)
					.addGroup(gl_panelCentral.createParallelGroup(Alignment.LEADING)
						.addComponent(panelTable, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 556, Short.MAX_VALUE)
						.addGroup(gl_panelCentral.createSequentialGroup()
			...
			gl_panelCentral.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelCentral.createSequentialGroup()
					...
					.addGroup(gl_panelCentral.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panelCentral.createSequentialGroup()
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(panelTable, GroupLayout.DEFAULT_SIZE, 101, Short.MAX_VALUE)))
					.addGap(28)
					.addGroup(gl_panelCentral.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnCreaProgetto)
						.addComponent(btnVisualizzaProgetto))
		...
		elencoAttributiPrg  = new DefaultTableModel(
				new Object[][]{},
				new String[]{ "Id progetto", "Nome progetto", "Data inizio", "Data fine", "Stato progetto", "Terreno"}
			);
